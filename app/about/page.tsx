    ...
    <div className="container-fluid min-h-screen max-h-auto px w-screen flex justify-center relative overflow-auto   items-center">
      ...
      <div className="row flex justify-center dark:bg-transparent dark:bg-opacity-50  bg-white bg-opacity-[80%] w-full h-full p-5 items-center ">
        <div className="col flex flex-col gap-10  lg:gap-10 md:gap-5 lg:flex-row md:flex-row  lg:p-7 px-2 py-2 items-center justify-between w-full h-full">
          ...
          <div className="middle w-full text-center border-2 z-[300] relative dark:bg-black dark:border-white border-pink-300  rounded-2xl p-5 bg-white">
          ...
          <div className="bottom  w-full text-center dark:bg-black dark:bg-opacity-70  relative rounded-2xl  p-5">
